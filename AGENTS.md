...
- ? Files remain valid for source-controlled canonical artifacts, config templates, generated outputs, guarded dev fixtures, import/export artifacts, invalidated caches, and ephemeral UI state. See `docs/system-of-record-gate.md`.
