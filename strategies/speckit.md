...
4. ! Store the temporary proposal artifact under `vbrief/.eval/decompositions/`; agents MUST NOT leave decomposition draft JSON files at the workspace root.
